...
export default class DirectorTecnicoController {
    ...
    getAll = async (req: Request, res: Response) => {
        ...
        let query = 'SELECT * FROM vistaDirectores';
        if (id == null) {
            ...
            let directores = data.map((director: any) => {
                return {
                    ...
                    country: director.pais,
                    photo: director.foto,
                    id_team: director.equipoID,
                    team: director.equipo
                }
            });
            ...
            query += ' WHERE directorTecnicoID = :id';
            ...
            if (data.length > 0) {
                let resultado = data.map((director: any) => {
                    return {
                        id: director.directorTecnicoID,
                        name: director.nombre,
                        lastname: director.apellido,
