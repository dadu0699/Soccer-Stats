    ...
    this.users = [
      {
        ...
        id_rol: 1, photo: 'https://www.latercera.com/resizer/Bh3lioSDt8GrjOEVcLSjSbYfRok=/900x600/smart/cloudfront-us-east-1.images.arcpublishing.com/copesa/6DKKPSIWJJFZNGNYFBVRLKIT6E.jpg', id_status: 1, age: 111, nationality: 'Pais 1'
      },
      {
        ...
        id_rol: 2, photo: 'https://mn2s-content.s3.eu-west-2.amazonaws.com/wp-content/uploads/2021/03/19174550/Chris-Wood.png',
         id_status: 2, age: 222, nationality: 'Pais 2'
      },
    ]; //TODO Delete info
